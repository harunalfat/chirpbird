...
export abstract class ISocketService {
    abstract initSocket(any: any): Promise<void>
    ...
    abstract subscribeServer<T>(cb: (message: ServerEventWrapper<T>) => void): void
    ...
    abstract addChannelRpc(channel: Channel): Promise<Channel>;
}